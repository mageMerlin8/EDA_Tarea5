    ...
    def insert(self, dato):
        ...
        if(self.root is None):
            ...
            if(self.root.right is not None):
                return self.__insertR(newNode, self.root.right)
            else:
            ...
            if(self.root.left is not None):
                return self.__insertR(newNode, self.root.left)
            else:
    ...
    def __insertR(self, newNode, treeNode):
        ...
        if(treeNode < newNode):
            if(treeNode.right is None):
                ...
                return self.__insertR(newNode, treeNode.right)
        elif(treeNode > newNode):
            if(treeNode.left is None):
                treeNode.left = newNode
                return True
            else:
                return self.__insertR(newNode, treeNode.left)
        else:
            return False
